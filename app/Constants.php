...
class Constants
{
  ...
  const TIPO_ARCHIVO_CURRICULUM = 'cv';
  const TIPO_ARCHIVO_INE = 'ine';
  const TIPO_ARCHIVO_CURP = 'curp';
  const TIPO_ARCHIVO_COMPROBANTE_DOMICILIO = 'domicilio';
  ...
  const TIPO_ARCHIVO_PLANEACION_ACADEMICA = 'planeacion_academica';
}
